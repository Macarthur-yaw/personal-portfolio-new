...
<>   
 <div className="sticky top-0 z-20 -mx-6 mb-4 w-screen  px-6 py-5 backdrop-blur md:-mx-12 md:px-12  lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 ">
           <h2 className="text-2xl tracking-widest font-serif text-center font-semibold text-slate-200 mb-4">
          EXPERIENCE
        </h2>
  ...
  <header className="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-2" aria-label="2018 to 2024">{content.dateRange}</header>
    ...
    <h3 className="font-medium leading-snug text-slate-200">
      <div>
        ...
        " target="_blank" rel="noreferrer noopener" aria-label="Lead Engineer at Upstatement (opens in a new tab)">
          {/* <span className=" -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span> */}
          <span className="text-[1rem]">{content.title} 
            </span>
        </a>
      </div>
    </h3>
